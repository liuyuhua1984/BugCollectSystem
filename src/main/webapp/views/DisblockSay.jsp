...
<div class="well">
	...
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane active in" id="home">
			...
			<form id="tab" method="post" action="${ctxPage}/forbid/disblock_say" autocomplete="off">
				<input type="hidden" name="opttype" value="5051" />
				...
				<label>禁言时间(分钟)</label>
				<input type="number" name="forbidtime" value="" class="input-xlarge" >
				<label>操作原因描述</label>
